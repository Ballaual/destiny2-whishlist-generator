                ...
                >
                  <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                      ...
                      <div className="entry-metadata" style={{ height: '1.3rem', position: 'relative', overflow: 'hidden' }}>
                        ...
                        {entry.tags && entry.tags.length > 0 && (
                          <div className="wishlist-entry-tags" style={{ display: 'none', gap: '0.25rem', flexWrap: 'wrap', position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, overflowY: 'auto' }}>
                            {entry.tags.map(tag => (
                                <span 
                                  key={tag} 
